                    ...
                    <div class="card  shadow">
                        <div class="card-header bg-white border-0">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h3 class="mb-0 h3_title">Blood Donation</h3>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('blood_donation.store') }}" autocomplete="off">
                                @csrf
                                <div class="pl-lg-4">
                                    ...
                                    <div class="form-group">
                                        <h5 class="form-control-label" for="input-region-name">{{ __('Organization') }}</h5>
                                        <select class="form-control form-control-alternative" name="blood_type">
